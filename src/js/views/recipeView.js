...
class RecipeView extends View {
  ...
  _errorMessage =
    ' We were not able to find the recipe. Please try another recipe keyword.';
  _message = '';

  //publisher- subscriber design for event listner func
  ...
  addHandlerAddBookmark(handler) {
    this._parentElement.addEventListener('click', function (e) {
      const btn = e.target.closest('.btn--bookamrk');
      if (!btn) return;
      handler();
    });
  }
    ...
    return `
      ...
      this._data.title
            ...
            <div class="recipe__details">
              ...
              <button class="btn--round btn--bookamrk">
                <svg class="">
